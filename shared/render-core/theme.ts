...
export const themeDefinitions: Record<PresetTheme, ThemeDefinition> = {
  ...
  [PresetTheme.LASER_GRID]: defineTheme([ThemeTone.CYAN, ThemeTone.PURPLE, ThemeTone.ROSE], createDetailedTheme(
    ['#070A12', '#1B2A6B', '#00D4FF', '#9B5CFF', '#FF2BA6'],
    ['#F7FBFF', '#C8F2FF', '#7AD7FF', '#9F8BFF', '#F55CB8'],
    {
      background: '#03050A',
      textMain: '#F2FBFF',
      textSub: '#93B4D8',
  ...
  [PresetTheme.BLACKLIGHT]: defineTheme([ThemeTone.PURPLE, ThemeTone.LIME, ThemeTone.CYAN], createDetailedTheme(
    ['#0C0714', '#32105C', '#7D2DFF', '#C7FF00', '#00F5D4'],
    ['#FFF7FF', '#EBCBFF', '#B985FF', '#A6D91A', '#18BFA9'],
    {
      background: '#05020A',
      textMain: '#FAF0FF',
      textSub: '#BDA5D0',
  ...
  [PresetTheme.PRISM_BREAK]: defineTheme([ThemeTone.RED, ThemeTone.YELLOW, ThemeTone.CYAN, ThemeTone.PURPLE], createDetailedTheme(
    ['#111827', '#EF4444', '#F59E0B', '#22D3EE', '#A78BFA'],
    ['#FFF9F2', '#FFD4D4', '#FFE08A', '#A7F3F9', '#BFA8FF'],
    {
      background: '#070B12',
      textMain: '#F8FAFC',
      textSub: '#A9B4C4',
  ...
  [PresetTheme.MATRIX_RAIN]: defineTheme([ThemeTone.GREEN, ThemeTone.LIME, ThemeTone.CYAN], createDetailedTheme(
    ['#020A07', '#053B22', '#0B7A3E', '#2DFF72', '#B8FF4D'],
    ['#F7FFF8', '#D8F9D2', '#92E897', '#30B95A', '#075E35'],
    {
      background: '#010504',
      textMain: '#E8FFE9',
      textSub: '#8DBA93',
  ...
  [PresetTheme.SOLAR_FLARE]: defineTheme([ThemeTone.YELLOW, ThemeTone.ORANGE, ThemeTone.RED], createDetailedTheme(
    ['#190806', '#6B130E', '#D9480F', '#FFB703', '#FFF27A'],
    ['#FFF9E6', '#FFE08A', '#FFB703', '#F97316', '#9A3412'],
    {
      background: '#0C0302',
      textMain: '#FFF4D6',
      textSub: '#D2A76E',
  ...
  [PresetTheme.OCEAN_REACTOR]: defineTheme([ThemeTone.BLUE, ThemeTone.TEAL, ThemeTone.LIME], createDetailedTheme(
    ['#06111F', '#073B5E', '#0077B6', '#00B4D8', '#A7FF83'],
    ['#F2FCFF', '#C7F2FF', '#73D7EF', '#18A6C5', '#4FAF4D'],
    {
      background: '#020812',
      textMain: '#EAFBFF',
      textSub: '#8FB9C8',
