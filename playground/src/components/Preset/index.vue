...
const presets = computed(() => {
  return _presets.map(
    (cfg): { cfg: ResolvedPresetConfig } => ({
      cfg: {
        ...cfg,
        dark: cfg.dark ?? activeAppearance.value.dark,
        strokeWidth: cfg.strokeWidth ?? activeAppearance.value.strokeWidth,
        strokeColor: cfg.strokeColor ?? activeAppearance.value.strokeColor,
