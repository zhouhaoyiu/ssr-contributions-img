...
describe('AppController', () => {
  ...
  it('should expose panel metadata and the random theme option', () => {
    ...
    expect(
      themeConfig?.optioins?.some((option) => option.value === 'laser_grid'),
    ).toBe(true);
    expect(
      themeConfig?.optioins?.some((option) => option.value === 'blacklight'),
    ).toBe(true);
    expect(
      themeConfig?.optioins?.some((option) => option.value === 'matrix_rain'),
    ).toBe(true);
